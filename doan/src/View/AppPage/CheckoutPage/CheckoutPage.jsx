                                ...
                                <div className="web-laptop-container mt-2 p-3" style={{ backgroundColor: "#FFF" }}>
                                    ...
                                    <div className="d-flex align-items-center justify-content-end pb-3" style={{ borderBottom: "1px solid black" }}>
                                        ...
                                        <Select
                                            ...
                                            onChange={(value) => {
                                                setState(value)
                                                // console.log(typeof defaultAddress === undefined)
                                            }}
                                        >
                                    ...
                                    <div className="d-flex justify-content-end mr-2 mt-2 pb-3">
                                        <Button
                                            disabled={defaultAddress === null || defaultAddress === "" || typeof defaultAddress === "undefined" || state === 0 || listCartChoose.length === 0 ? true : false}
                                            type="primary"
                                            danger
                                            className="mt-2"
