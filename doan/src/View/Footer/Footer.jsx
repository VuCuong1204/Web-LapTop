        ...
        <div className="pt-5 web-laptop-footer">
            <div className="web-laptop-footer-content">
                ...
                <div className="mt-2 text-xl-center ">
                    ...
                    <div className="d-flex">
                        <div className="web-laptop-footer-content-name">
                            <a href="https://www.facebook.com/minhvu.147" target="blank" ><span className="text-white">Vũ Tấn Minh</span></a>
                        </div>
                        <div className="web-laptop-footer-content-id">
                    ...
                    <div className="d-flex">
                        <div className="web-laptop-footer-content-name">
                            <a href="https://www.facebook.com/profile.php?id=100017649671970" target="blank" ><span className="text-white">Vũ Quốc Cường</span></a>
                        </div>
                        <div className="web-laptop-footer-content-id">
                    ...
                    <div className="d-flex">
                        <div className="web-laptop-footer-content-name">
                            <a href="https://www.facebook.com/nguyentiendung08022001/" target="blank" ><span className="text-white">Nguyễn Tiến Dũng</span></a>
                        </div>
                        <div className="web-laptop-footer-content-id">
