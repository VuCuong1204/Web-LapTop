...
if(isset($_POST['productId'])) {
 $productId =$_POST['productId'];
  ...
  $productRam= "";
if(isset($_POST['productRam'])) {
 $productRam =$_POST['productRam'];
}

  $productRom= "";
if(isset($_POST['productRom'])) {
 $productRom =$_POST['productRom'];
}
...
||$productRom == "" ) {
   getResult(-2,"Vui lòng nhập đủ thông tin");
    ...
    $object1 = getProductDetailList($productId,$productRam,$productRom,$con);
    $data = new dataObject($object,$object1);
...
function getProductDetailList($productId,$productRam,$productRom,$con) {
    $query = "SELECT * FROM productDetail where productId = '$productId' and productRam = '$productRam' and productRom= '$productRom'";
    $data =  mysqli_query($con,$query);
